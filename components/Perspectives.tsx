export const Perspectives = () => (
  <section id='perspectives'>
    ...
    <details>
      <summary>Go slow, always stay moving</summary>
    ...
    <details>
      <summary>Commit to the fewest decisions possible</summary>
    ...
    <details>
      <summary>Clearing a path for the least advantaged creates a path for everyone</summary>
