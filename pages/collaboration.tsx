          ...
          <section>
            <div className='content'>
              <div className='inner'>
                ...
                <p>
                  I adapt to my environment; however, I do not conform to my environment. I bring my sense of humor when submitting PRs, but I hold it back when commenting on someone else's. If I have a concern with how an interaction occurred, I'll follow-up with the people involved directly, and I expect the same in return. We spend the majority of our lives in our workspaces, so we cannot simply check our baggage at the door; if I am frustrated with how someone engages, my first question is how I can alter my expectations of them and not how they can change to accommodate me.
                </p>
              </div>
            </div>
          </section>
