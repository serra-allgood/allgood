      ...
      <div id='main'>
        <section id='one'>
          <div className='inner'>
            ...
            <p>
              Since childhood, I have experienced major depression and was disagnosed as such after I attempted suicide at the age of 16. Atmy current age, my depression most commonly manifests as feeling so overwhelmed that I have great difficulty doing anything other than sleep. Very recent life events have significantly curtailed this behavior however.
            </p>
          </div>
        </section>
        <section id='two'>
          <div className='inner'>
            ...
            <p>
              Very recent life events have convinced me that although these are delusions to anyone else, they are very real to me. As such, I refuse to live in fear, and I also refuse to simply suffer in silence; my emotional affect when I meet people is intentionally flat, my answers are curt and direct, and my responses to common greetings such as, "How are you?" are highly idiosyncratic (eg, I answer, "I'm alive," when asked that question). I no longer trust easily, particularly representatives of systemtic organizations, and without trust, I do not feel safe to be vulnerable with my emotions; feeling like it's not safe to cry alone inside my own apartment is very frustrating.
            </p>
            <p>
