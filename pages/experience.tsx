      ...
      <div id='main'>
        <section id='one'>
          <div className='inner'>
            ...
            <p>
              Much of what I grew at Procore weren't raw technical skills though, but the soft skills that develop in an environment designed to empower its members with autonomy and mastery. I grew confident in proposing ideas, adapting and demonstrating personal techniques, as well as my emotional limitations in working in what I perceive to be crises.
            </p>
            <p>
